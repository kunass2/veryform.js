...
(function($){
	...
	$.fn.formex = function(myopts) {
		...
		var def_message = { text : 'nic nie wpisano', email : 'nie poprawny e-mail', checkbox : 'nie wybrano', textarea : 'nic nie wpisano', radio : 'nie wybrano', select : 'nie wybrano', file: 'nie wybrano pliku', password: 'zĹe hasĹo' };
		var opts = {
			wrap: false,
			wrapClass: '',
			setMessages : false,
